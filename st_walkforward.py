...
show("ST 10/3.0 always-in", {"atr_period": 10, "multiplier": 3.0, "long_only": 0})
show("ST 10/3.0 long-only", {"atr_period": 10, "multiplier": 3.0, "long_only": 1})
show("ST 10/2.0 always-in", {"atr_period": 10, "multiplier": 2.0, "long_only": 0})
show("ST 14/3.0 always-in", {"atr_period": 14, "multiplier": 3.0, "long_only": 0})
show("ST 20/4.0 long-only", {"atr_period": 20, "multiplier": 4.0, "long_only": 1})
print("\nALL DONE", flush=True)
